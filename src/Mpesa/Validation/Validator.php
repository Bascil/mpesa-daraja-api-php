<?php
namespace Bascil\Mpesa\Validation;

use Bascil\Mpesa\Validation\ValidatorInterface;
...
class Validator implements ValidatorInterface
{
    ...
    /**
     * @var \Bascil\Mpesa\Validation\RuleFactory
     */
     ...
     *
     * @var \Bascil\Mpesa\Validation\DataWrapper\WrapperInterface
     */
     ...
     *
     * @return \Bascil\Mpesa\Validation\RuleFactory
     */
     ...
     *
     * @return \Bascil\Mpesa\Validation\Rule\AbstractValidator
     */
    ...
    public function remove($selector, $name = true, $options = null)
    {
        ...
        /* @var $collection \Bascil\Mpesa\Validation\ValueValidator */
     ...
     * @param mixed $data
     *
     * @return \Bascil\Mpesa\Validation\DataWrapper\WrapperInterface
     */
    ...
    public function validate($data = null)
    {
        ...
        foreach ($this->rules as $selector => $valueValidator) {
            foreach ($this->getDataWrapper()->getItemsBySelector($selector) as $valueIdentifier => $value) {
                /* @var $valueValidator \Bascil\Mpesa\Validation\ValueValidator */
