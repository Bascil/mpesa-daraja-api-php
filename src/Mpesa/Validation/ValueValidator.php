...
use Bascil\Mpesa\Validation\Rule\AbstractRule;
...
class ValueValidator
{
     ...
     *
     * @var \Bascil\Mpesa\Validation\ErrorMessage
     */
     ...
     *
     * @var \Bascil\Mpesa\Validation\RuleCollection
     */
    protected $rules;
    ...
    public function validate($value, $valueIdentifier = null, DataWrapper\WrapperInterface $context = null)
    {
        ...
        /* @var $rule \Bascil\Mpesa\Validation\Rule\AbstractValidator */
        foreach ($this->rules as $rule) {
