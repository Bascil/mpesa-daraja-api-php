...
use Bascil\Mpesa\Validation\DataWrapper\ArrayWrapper;
use Bascil\Mpesa\Validation\DataWrapper\WrapperInterface;
use Bascil\Mpesa\Validation\ErrorMessage;
...
abstract class AbstractRule
{
     ...
     * @param mixed $value
     *
     * @return \Bascil\Mpesa\Validation\Rule\AbstractRule
     */
    ...
    public function setContext($context = null)
    {
        ...
        if (! is_object($context) || ! $context instanceof WrapperInterface) {
            throw new \InvalidArgumentException(
                ...
                of Bascil\Mpesa\Validator\DataWrapper\WrapperInterface'
            );
        }
     ...
     *
     * @return NULL|\Bascil\Mpesa\Validation\ErrorMessage
     */
