...
use Bascil\Mpesa\Validation\Rule\Callback as CallbackRule;
...
class RuleFactory
{
    ...
    {
        if (is_subclass_of($class, '\Bascil\Mpesa\Validation\Rule\AbstractRule')) {
    ...
    protected function construcRuleByNameAndOptions($name, $options)
    {
        if (is_callable($name)) {
            ...
            if (class_exists('\Bascil\Mpesa\Validation\Rule\\' . $name, false)) {
                $name = '\Bascil\Mpesa\Validation\Rule\\' . $name;
            }
            // at this point we should have a class that can be instanciated
            if (class_exists($name) && is_subclass_of($name, '\Bascil\Mpesa\Validation\Rule\AbstractRule')) {
